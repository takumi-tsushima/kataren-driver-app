...
import { CalendarDays, AlertCircle, ChevronRight, CheckCircle2, XCircle, Lock, UserCog, FileText } from 'lucide-react'
        ...
        <div className="home-container">
            ...
            <div className="card">
                ...
                <button
                    ...
                    style={{ marginTop: '12px', background: '#7c3aed', color: '#ffffff' }}
                >
