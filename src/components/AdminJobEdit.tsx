...
export const AdminJobEdit = ({ jobId, onBack }: Props) => {
    ...
    const isValid = useMemo(() => {
        ...
        // 新仕様：pickup/dropoff/area_tag が揃っていればOK
        // 互換：legacy location のみでもOK（既存案件の編集を壊さない）
    ...
    return (
        <div className="w-full pb-24">
            <div className="flex justify-between items-start gap-4 mb-5 flex-wrap">
                <div>
                    <h2 className="m-0 text-2xl font-bold text-slate-900">案件編集</h2>
                    <p className="mt-1.5 text-slate-600 text-sm">掲載中案件の内容を編集できます。</p>
                    {groupId && (
